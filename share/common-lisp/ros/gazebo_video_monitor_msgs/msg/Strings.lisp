...
(cl:defmethod cl:initialize-instance :after ((m <Strings>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Strings)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_video_monitor_msgs-msg:<Strings> is deprecated: use gazebo_video_monitor_msgs-msg:Strings instead.")))

(cl:ensure-generic-function 'names-val :lambda-list '(m))
(cl:defmethod names-val ((m <Strings>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_video_monitor_msgs-msg:names-val is deprecated.  Use gazebo_video_monitor_msgs-msg:names instead.")
  (names m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Strings>)))
  ...
  "gazebo_video_monitor_msgs/Strings")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Strings)))
  "Returns string type for a message object of type 'Strings"
  "gazebo_video_monitor_msgs/Strings")
